...
13)三个非常深的神经网络，分别是ResNet、HighwayNet和DenseNet，以及它们在Tensorflow上的实现。作者用CIFAR10数据集训练这些网络进行图像分类，在一小时左右的训练之后均实现了90%以上的精度。
...
gituhb开源的精品AI项目https://blog.csdn.net/guyuealian/article/details/81223084?tdsourcetag=s_pcqq_aiomsg
